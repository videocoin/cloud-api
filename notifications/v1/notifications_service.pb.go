...
func init() {
	proto.RegisterFile("notifications/v1/notifications_service.proto", fileDescriptor_notifications_service_6e65a46b40aadcfb)
}
func init() {
	golang_proto.RegisterFile("notifications/v1/notifications_service.proto", fileDescriptor_notifications_service_6e65a46b40aadcfb)
}

var fileDescriptor_notifications_service_6e65a46b40aadcfb = []byte{
