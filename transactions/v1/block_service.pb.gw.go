...
var (
	filter_BlockService_GetBlocks_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_BlockService_GetBlocks_0(ctx context.Context, marshaler runtime.Marshaler, client BlockServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
// RegisterBlockServiceHandlerClient registers the http handlers for service BlockService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "BlockServiceClient".
...
func RegisterBlockServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BlockServiceClient) error {
	...
	mux.Handle("GET", pattern_BlockService_GetBlocks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_BlockService_GetBlocks_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_BlockService_GetBlocks_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
