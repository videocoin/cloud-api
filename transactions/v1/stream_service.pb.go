...
func (m *GetStreamInfoRequest) GetStreamId() string {
	if m != nil {
		return m.StreamId
	}
	return ""
...
var fileDescriptorStreamService = []byte{
	...
	0x84, 0xa4, 0xb9, 0x38, 0xa1, 0xae, 0xce, 0x4c, 0x91, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0xe2,
	...
	0xee, 0x35, 0x1c, 0x7d, 0x03, 0x02, 0x00, 0x00,
}
