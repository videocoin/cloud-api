...
var (
	filter_ManagerService_Run_0 = &utilities.DoubleArray{Encoding: map[string]int{"stream_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	filter_ManagerService_Stop_0 = &utilities.DoubleArray{Encoding: map[string]int{"stream_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	filter_ManagerService_Get_0 = &utilities.DoubleArray{Encoding: map[string]int{"stream_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	...
	pattern_ManagerService_Run_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "job", "stream_id", "run"}, ""))

	pattern_ManagerService_Stop_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"api", "v1", "job", "stream_id", "stop"}, ""))

	pattern_ManagerService_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "job", "stream_id"}, ""))

	pattern_ManagerService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "job", "stream_id"}, ""))
