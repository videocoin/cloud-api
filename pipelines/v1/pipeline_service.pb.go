...
func (*CreatePipelineRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_service_b37a5acbb3da4ed2, []int{0}
}
...
func (*PipelineRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_service_b37a5acbb3da4ed2, []int{1}
}
...
func (*ListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_service_b37a5acbb3da4ed2, []int{2}
}
...
func (*UpdatePipelineRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_service_b37a5acbb3da4ed2, []int{3}
}
...
func (m *UpdatePipelineRequest) GetProfileId() proto1.ProfileId {
	if m != nil {
		return m.ProfileId
	}
...
func init() {
	proto.RegisterFile("pipelines/v1/pipeline_service.proto", fileDescriptor_pipeline_service_b37a5acbb3da4ed2)
}

var fileDescriptor_pipeline_service_b37a5acbb3da4ed2 = []byte{
	// 682 bytes of a gzipped FileDescriptorProto
	,
}
