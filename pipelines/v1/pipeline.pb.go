...
func (PipelineStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_7cf5a55a661f1a6d, []int{0}
}
...
func (*PipelineProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_7cf5a55a661f1a6d, []int{1}
}
...
func init() {
	proto.RegisterFile("pipelines/v1/pipeline.proto", fileDescriptor_pipeline_7cf5a55a661f1a6d)
}
func init() {
	golang_proto.RegisterFile("pipelines/v1/pipeline.proto", fileDescriptor_pipeline_7cf5a55a661f1a6d)
}

var fileDescriptor_pipeline_7cf5a55a661f1a6d = []byte{
	// 802 bytes of a gzipped FileDescriptorProto
	,
}
