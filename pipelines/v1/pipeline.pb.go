...
import v11 "github.com/videocoin/cloud-api/jobs/v1"
...
func (*Pipeline) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_e855d43d15208253, []int{0}
}
...
func (*PipelineProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_pipeline_e855d43d15208253, []int{1}
}
...
func init() {
	proto.RegisterFile("pipelines/v1/pipeline.proto", fileDescriptor_pipeline_e855d43d15208253)
}
func init() {
	golang_proto.RegisterFile("pipelines/v1/pipeline.proto", fileDescriptor_pipeline_e855d43d15208253)
}

var fileDescriptor_pipeline_e855d43d15208253 = []byte{
