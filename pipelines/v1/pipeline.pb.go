...
func (m *Pipeline) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PendingAt != nil {
		...
		n2, err2 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.PendingAt, dAtA[i:])
		if err2 != nil {
			return 0, err2
		}
		i += n2
	...
	if m.RunningAt != nil {
		...
		n3, err3 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.RunningAt, dAtA[i:])
		if err3 != nil {
			return 0, err3
		}
		i += n3
	...
	if m.StoppedAt != nil {
		...
		n4, err4 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.StoppedAt, dAtA[i:])
		if err4 != nil {
			return 0, err4
		}
		i += n4
...
func (m *PipelineProfile) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.JobProfile != nil {
		...
		n5, err5 := m.JobProfile.MarshalTo(dAtA[i:])
		if err5 != nil {
			return 0, err5
		}
		i += n5
	...
	if m.PendingAt != nil {
		...
		i++
		i = encodeVarintPipeline(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.PendingAt)))
		n7, err7 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.PendingAt, dAtA[i:])
		if err7 != nil {
			return 0, err7
		}
		i += n7
	...
	if m.RunningAt != nil {
		...
		i++
		i = encodeVarintPipeline(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.RunningAt)))
		n8, err8 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.RunningAt, dAtA[i:])
		if err8 != nil {
			return 0, err8
		}
		i += n8
	...
	if m.StoppedAt != nil {
		...
		i++
		i = encodeVarintPipeline(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.StoppedAt)))
		n9, err9 := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.StoppedAt, dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += n9
