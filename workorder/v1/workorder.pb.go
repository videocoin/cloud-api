...
func (WorkOrderStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_workorder_8947068f63ffa322, []int{0}
}
...
func (IngestStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_workorder_8947068f63ffa322, []int{1}
}
...
func (*JobProfiles) Descriptor() ([]byte, []int) {
	return fileDescriptor_workorder_8947068f63ffa322, []int{2}
}
...
func init() {
	proto.RegisterFile("workorder/v1/workorder.proto", fileDescriptor_workorder_8947068f63ffa322)
}
func init() {
	golang_proto.RegisterFile("workorder/v1/workorder.proto", fileDescriptor_workorder_8947068f63ffa322)
}

var fileDescriptor_workorder_8947068f63ffa322 = []byte{
	...
	,
}
