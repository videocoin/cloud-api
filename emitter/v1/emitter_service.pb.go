...
func (*StreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_emitter_service_d7fe7fc2cb09613e, []int{0}
}
...
type EmitterServiceClient interface {
	...
	EndStream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *emitterServiceClient) EndStream(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type EmitterServiceServer interface {
	...
	EndStream(context.Context, *StreamRequest) (*empty.Empty, error)
}
...
func init() {
	proto.RegisterFile("emitter/v1/emitter_service.proto", fileDescriptor_emitter_service_d7fe7fc2cb09613e)
}

var fileDescriptor_emitter_service_d7fe7fc2cb09613e = []byte{
	// 416 bytes of a gzipped FileDescriptorProto
	,
}
